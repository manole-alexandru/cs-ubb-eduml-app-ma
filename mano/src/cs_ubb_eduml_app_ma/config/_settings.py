...
class MlflowSettings:
    enabled: bool = False
    tracking_uri: str = ""
    experiment_name: str = "cs-ubb-eduml-app-ma-experiment"
...
class MinioSettings:
    ...
    path: str = "cs-ubb-eduml-app-ma/data.csv"
    user: str | None = None
...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        mlflow_settings = MlflowSettings(
            ...
            experiment_name=cls.read_str_from_env("MLFLOW_EXPERIMENT_NAME", "cs-ubb-eduml-app-ma-experiment")
        )
        minio_settings = MinioSettings(
            ...
            path=cls.read_str_from_env("MINIO_OBJECT_PATH", "cs-ubb-eduml-app-ma/data.csv"),
