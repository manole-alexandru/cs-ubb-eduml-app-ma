...
def fit_standford_cars(epochs: int, lr: float, max_lr: float, model_name: str):
    ...
    train_loader_classic  = DataLoader(train_dataset, batch_size=8, shuffle=True)
    val_loader_clasic = DataLoader(val_dataset, batch_size=8, shuffle=False)
    test_loader_clasic = DataLoader(test_dataset, batch_size=8, shuffle=False)
    ...
    train_loader_parallel = DataLoader(train_dataset_hierarchic, batch_size=32, shuffle=True, num_workers=1)
    val_loader_parallel = DataLoader(val_dataset_hierarchic, batch_size=32, shuffle=False, num_workers=1)
    test_loader_parallel = DataLoader(test_dataset_hierarchic, batch_size=32, shuffle=False, num_workers=1)
    ...
    return None, None, trained_classic_model, eval_metrics(np.ones((1,5)), np.ones((1, 5)))
...
if __name__ == "__main__":
    ...
    fit_standford_cars(epochs, lr, max_lr, model_name)
